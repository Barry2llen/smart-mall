...
public class CouponSpuRelationController {
    ...
    @Operation(summary = "获取CouponSpuRelation列表")
    @GetMapping("/list")
    public R<List<CouponSpuRelation>> getCouponSpuRelations(@RequestParam Integer pageNum, @RequestParam Integer pageSize) {
        return R.success(couponSpuRelationService.list(new Page<>(pageNum, pageSize)));
    }
