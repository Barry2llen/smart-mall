...
public class MemberPriceController {
    ...
    @Operation(summary = "获取MemberPrice列表")
    @GetMapping("/list")
    public R<List<MemberPrice>> getMemberPrices(@RequestParam Integer pageNum, @RequestParam Integer pageSize) {
        return R.success(memberPriceService.list(new Page<>(pageNum, pageSize)));
    }
