...
(
   attr_id              bigint(20) zerofill not null comment '属性id',
...
(
   id                   bigint(20) zerofill not null comment 'id',
...
(
   attr_group_id        bigint(20) zerofill not null comment '分组id',
...
(
   brand_id             bigint(20) zerofill not null comment '品牌id',
...
(
   cat_id               bigint(20) zerofill not null comment '分类id',
...
(
   sku_id               bigint(20) zerofill not null comment 'skuId',
...
(
   id                   bigint(20) zerofill not null comment '商品id',
